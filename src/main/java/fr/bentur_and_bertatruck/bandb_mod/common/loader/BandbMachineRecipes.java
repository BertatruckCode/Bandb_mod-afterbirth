...
public class BandbMachineRecipes {
	...
	public static void init(){
		...
		RecipeSyrupMachine.addRecipe(BandbFood.itemFoodCaramel , new ItemStack(BandbBeverages.itemSyrupCaramel ));
		...
		RecipeSyrupMachine.addRecipe(BandbFood.itemFoodChocolate , new ItemStack(BandbBeverages. itemSyrupChocolate ));
		...
		RecipeSyrupMachine.addRecipe(BandbFood.itemFoodBarba , new ItemStack(BandbBeverages.itemSyrupCottonCandy ));
		...
		RecipeSyrupMachine.addRecipe(BandbFood.itemFoodGingerBread , new ItemStack(BandbBeverages.itemSyrupGingerBread ));
		...
		RecipeSyrupMachine.addRecipe(BandbFood.itemFoodHoney , new ItemStack(BandbBeverages.itemSyrupHoney ));
		...
		RecipeSyrupMachine.addRecipe(BandbFood.itemFoodSaltedCaramel , new ItemStack(BandbBeverages.itemSyrupSaltedCaramel ));
		...
		RecipeSyrupMachine.addRecipe(BandbFood.itemFoodWhiteChocolate, new ItemStack(BandbBeverages.itemSyrupWhiteChocolate ));
		...
		RecipeSyrupMachine.addRecipe(BandbFood.itemFoodChocolate, Items.cookie , new ItemStack(BandbBeverages.itemSyrupChocolateCookie));	
		RecipeSyrupMachine.addRecipe(BandbFood.itemFoodChocolate, BandbItems.itemMint , new ItemStack(BandbBeverages.itemSyrupChocolateMint));	
		RecipeSyrupMachine.addRecipe(BandbItems.itemMint, BandbFood.itemFoodIceCube , new ItemStack(BandbBeverages.itemSyrupFrostedMint));	
		...
		RecipeSyrupMachine.addRecipe(BandbFood.itemFoodChocolate, BandbItems.itemNuts , new ItemStack(BandbBeverages.itemSyrupPraline));	
		...
		RecipeSyrupMachine.addRecipe(BandbBeverages.itemJuiceLemon, BandbItems.itemLime, BandbFood.itemFoodIceCube, new ItemStack(BandbBeverages.itemSyrupGlascoLemon));	
		RecipeSyrupMachine.addRecipe(BandbBeverages.itemJuiceLime, BandbItems.itemLime, BandbFood.itemFoodIceCube, new ItemStack(BandbBeverages.itemSyrupLimeJuiceCordialMixer));	
		...
		RecipeDrier.addRecipe(BandbItems.itemCelery, new ItemStack(BandbFood.itemFoodCelerySalt));
		...
		RecipePrinter.addRecipe(BandbBeverages.itemBottleSiropMoninOrangeLabel, 3, 3, 3, 3);
		...
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleHoneyWOLabel, BandbBeverages.itemLabelHoney, new ItemStack(BandbBeverages.itemBottleHoney));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSchweppesAgrumWOLabel, BandbBeverages.itemLabelSchweppesAgrum, new ItemStack(BandbBeverages.itemBottleSchweppesAgrum));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSchweppesDarkSideWOLabel, BandbBeverages.itemLabelSchweppesDarkSide, new ItemStack(BandbBeverages.itemBottleSchweppesDarkSide));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSchweppesLemonWOLabel, BandbBeverages.itemLabelSchweppesLemon, new ItemStack(BandbBeverages.itemBottleSchweppesLemon));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSchweppesMangoWOLabel, BandbBeverages.itemLabelSchweppesMango, new ItemStack(BandbBeverages.itemBottleSchweppesMango));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSchweppesPamplemousseWOLabel, BandbBeverages.itemLabelSchweppesPamplemousse, new ItemStack(BandbBeverages.itemBottleSchweppesPamplemousse));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSchweppesPassionWOLabel, BandbBeverages.itemLabelSchweppesPassion, new ItemStack(BandbBeverages.itemBottleSchweppesPassion));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSchweppesPechWOLabel, BandbBeverages.itemLabelSchweppesPech, new ItemStack(BandbBeverages.itemBottleSchweppesPech));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSchweppesPommeWOLabel, BandbBeverages.itemLabelSchweppesPomme, new ItemStack(BandbBeverages.itemBottleSchweppesPomme));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSchweppesRicqlesWOLabel, BandbBeverages.itemLabelSchweppesRicqles, new ItemStack(BandbBeverages.itemBottleSchweppesRicqles));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottle1664WOLabel, BandbBeverages.itemLabel1664, new ItemStack(BandbBeverages.itemBottle1664));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleAlsaceRieslingWOLabel, BandbBeverages.itemAlsaceRieslingLabel, new ItemStack(BandbBeverages.itemBottleAlsaceRiesling));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBenturColaWOLabel, BandbBeverages.itemBenturColaLabel, new ItemStack(BandbBeverages.itemBottleBenturCola));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleChouchenWOLabel, BandbBeverages.itemChouchenLabel, new ItemStack(BandbBeverages.itemBottleChouchen));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleLiqueurWOLabel, BandbBeverages.itemLiquorLabel, new ItemStack(BandbBeverages.itemBottleLiqueur));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottlePastis51WOLabel, BandbBeverages.itemPastis51Label, new ItemStack(BandbBeverages.itemBottlePastis51));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleWhiskeyWOLabel, BandbBeverages.itemWhiskeyLabel, new ItemStack(BandbBeverages.itemBottleWhiskey));	
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleBourgogneAligoteWOLabel, BandbBeverages.itemBourgogneAligoteLabel, new ItemStack(BandbBeverages.itemBottleBourgogneAligote));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleBrittWOLabel, BandbBeverages.itemLabelBritt, new ItemStack(BandbBeverages.itemBottleBritt));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleDesperadosWOLabel, BandbBeverages.itemLabelDesperados, new ItemStack(BandbBeverages.itemBottleDesperados));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleEnateWOLabel, BandbBeverages.itemEnateLabel, new ItemStack(BandbBeverages.itemBottleEnate));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleDuvelWOLabel, BandbBeverages.itemLabelDuvel, new ItemStack(BandbBeverages.itemBottleDuvel));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleGet27WOLabel, BandbBeverages.itemLabelGet27, new ItemStack(BandbBeverages.itemBottleGet27));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleGrimberWOLabel, BandbBeverages.itemLabelGrimbergen, new ItemStack(BandbBeverages.itemBottleGrimbergen));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleLeffeWOLabel, BandbBeverages.itemLabelLeffe, new ItemStack(BandbBeverages.itemBottleLeffe));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSanMiguelWOLabel, BandbBeverages.itemLabelSanMiguel, new ItemStack(BandbBeverages.itemBottleSanMiguel));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemSchweppesRaisinWOLabel, BandbBeverages.itemLabelSchweppesRaisin, new ItemStack(BandbBeverages.itemBottleSchweppesRaisin));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSkollWOLabel, BandbBeverages.itemLabelSkoll, new ItemStack(BandbBeverages.itemBottleSkoll));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSmirnoffWOLabel, BandbBeverages.itemLabelSmirnoff, new ItemStack(BandbBeverages.itemBottleSmirnoff));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleSouthernComfortWOLabel, BandbBeverages.itemSouthernComfortLabel, new ItemStack(BandbBeverages.itemBottleSouthernComfort));
		RecipeLabelMachine.addRecipe(BandbBeverages.itemBottleXIIWOLabel, BandbBeverages.itemLabelXII, new ItemStack(BandbBeverages.itemBottleXII));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemFlute, BandbBeverages.itemBeverageAlsaceRiesling, BandbBeverages.itemBeveragePerrier, new ItemStack(BandbCocktails.itemCocktailSpritzer));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageCognac, BandbBeverages.itemBeverageSchweppesGingerAle, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailBrandyHighball));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageGin, BandbBeverages.itemLiqueurMint, BandbBeverages.itemBeveragePerrier, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailGreenHat));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageGin, BandbBeverages.itemJuiceGrapefruit, BandbBeverages.itemBeveragePerrier, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailNickySFizz));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageWhiteRum, BandbItems.itemLime, BandbBeverages.itemBeverageBenturCola, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailCubaLibre));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageTequila, BandbBeverages.itemJuiceOrange, BandbBeverages.itemBeverageLimonade, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailAlamoSplash));
		RecipeCocktailBar.addRecipe(BandbItems.itemOldFashoned, BandbBeverages.itemBeverageTequila, BandbBeverages.itemJuiceLime, BandbBeverages.itemBeverageLimonade, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailChanguirongo));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemOldFashoned, BandbBeverages.itemBeverageTequila, BandbItems.itemLime, BandbBeverages.itemBeverageBenturCola, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailMexicola));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageTequila, BandbItems.itemLime, BandbBeverages.itemBeverageSchweppesTonic, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailTNTCocktail));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageCognac, BandbBeverages.itemLiqueurBlackcurrant, BandbBeverages.itemBeveragePerrier,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailCassisco));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageGin, BandbBeverages.itemBeveragePerrier, BandbItems.itemCucumber,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailPimmSCup));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemOldFashoned, BandbBeverages.itemJuiceLychee, BandbBeverages.itemJuicePassionfruit, BandbBeverages.itemBeverageSchweppesGingerAle,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailAsianPassion));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemJuiceGrapefruit, BandbBeverages.itemBeveragePerrier, BandbBeverages.itemSyrupGrenadine,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailGrapefruitCooler));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemOldFashoned, BandbBeverages.itemJuicePassionfruit, BandbBeverages.itemJuiceLemon, BandbBeverages.itemBeverageLimonade,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailPassionCooler));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeveragePerrier, BandbBeverages.itemSyrupRaspberry, BandbItems.itemLime,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailPurplePash));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageVodka, BandbBeverages.itemJuiceGrapefruit, BandbBeverages.itemLiqueurBlackcurrant, BandbBeverages.itemBeveragePerrier, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailBurgundyJuicer));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageVodka, BandbBeverages.itemLiqueurOrange, BandbBeverages.itemBeverageSchweppesGingerAle, BandbItems.itemOrange, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailNapoli));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageVodka, BandbBeverages.itemBeverageRedMartini, BandbBeverages.itemBeveragePerrier, BandbItems.itemOrange, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailTestaRossa));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageGin, BandbBeverages.itemJuiceLime, BandbBeverages.itemBeverageSchweppesGingerAle, BandbItems.itemLime,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailShadyGrove));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageWhiskey, BandbBeverages.itemJuiceLemon, BandbBeverages.itemSyrupPureCaneSugar, BandbBeverages.itemBeverageSchweppesGingerAle, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailHighlandCooler));
		RecipeCocktailBar.addRecipe(BandbItems.itemOldFashoned, BandbBeverages.itemBeverageWhiskey, BandbBeverages.itemJuiceLime, BandbBeverages.itemBeverageCuracaoTripleSec, BandbBeverages.itemBeveragePerrier, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailHighVoltage));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageWhiskey, BandbBeverages.itemJuiceLime, BandbBeverages.itemBeverageCuracaoOrange, BandbBeverages.itemBeverageSchweppesGingerAle, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailKentuckyTea));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageWhiskey, BandbBeverages.itemSyrupPureCaneSugar, BandbItems.itemLemon, BandbBeverages.itemBeverageSchweppesGingerAle, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailKlondikeCooler));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageBrownRum, BandbItems.itemLime, BandbBeverages.itemLiqueurCoffee, BandbBeverages.itemBeveragePerrier, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailRumble));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageBrownRum, BandbBeverages.itemJuiceLemon, BandbBeverages.itemBeverageSchweppesGingerAle, BandbItems.itemLemon, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailSuzieTaylor));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageCognac, BandbBeverages.itemLiqueurBanana, BandbItems.itemLime,BandbBeverages.itemBeverageLimonade,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailDeeLight));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageCognac, BandbItems.itemLemon, BandbBeverages.itemBeverageAngosturaBitter,BandbBeverages.itemBeverageSchweppesGingerAle,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailHorseSNeck));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeveragePisco, BandbBeverages.itemJuiceLemon, BandbBeverages.itemBeverageAngosturaBitter,BandbBeverages.itemBeverageBenturCola,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailPiscola));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemLiqueurApricot, BandbBeverages.itemJuiceLemon, BandbBeverages.itemSyrupGrenadine,BandbBeverages.itemBeveragePerrier,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailApricotCooler));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemJuiceOrange, BandbItems.itemOrange, BandbBeverages.itemSyrupPureCaneSugar,BandbBeverages.itemBeverageSchweppesGingerAle,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailBullSEye));
		RecipeCocktailBar.addRecipe(BandbItems.itemOldFashoned, BandbBeverages.itemJuiceLemon, BandbBeverages.itemBeveragePerrier, BandbBeverages.itemSyrupRaspberry,BandbItems.itemLemon,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailRaspberrySquash));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageSchweppesGingerAle, BandbBeverages.itemBeverageLimonade, BandbBeverages.itemSyrupGrenadine,BandbItems.itemLime,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailShirleyTemple));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemJuiceLemon, BandbItems.itemStrawberry, BandbBeverages.itemSyrupPureCaneSugar,BandbBeverages.itemBeveragePerrier,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailStrawberryCooler));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemJuiceLime, BandbItems.itemCucumber, BandbBeverages.itemSyrupPureCaneSugar,BandbBeverages.itemBeveragePerrier,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailCucumberCooler));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemJuiceCarrot, BandbBeverages.itemJuiceLime, BandbItems.itemLime,BandbBeverages.itemBeveragePerrier,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailRabbitCooler));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageVodka, BandbBeverages.itemJuiceLime, BandbBeverages.itemSyrupPureCaneSugar, BandbItems.itemIceCube,BandbBeverages.itemBeveragePerrier, BandbItems.itemLime, new ItemStack(BandbCocktails.itemCocktailKremlinCooler));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageGin, BandbBeverages.itemJuiceLime, BandbBeverages.itemSyrupPureCaneSugar, BandbItems.itemMint, BandbBeverages.itemBeveragePerrier,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailAlabamaFizz));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageGin, BandbBeverages.itemJuiceLemon, BandbBeverages.itemSyrupPureCaneSugar, BandbBeverages.itemBeveragePerrier, BandbItems.itemLemon,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailJohnCollins));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageWhiskey, BandbBeverages.itemJuiceLemon, BandbBeverages.itemBeverageCuracaoTripleSec, BandbBeverages.itemBeverageLimonade, BandbItems.itemLemon, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailLynchburgLemonade));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageWhiskey, BandbBeverages.itemJuiceLemon, BandbBeverages.itemJuiceLime, BandbBeverages.itemSyrupGrenadine, BandbBeverages.itemBeveragePerrier, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailCaliforniaLemonade));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemCocktailGlass, BandbBeverages.itemBeverageWhiskey, Items.egg, BandbBeverages.itemBeveragePerrier, BandbBeverages.itemSyrupPureCaneSugar, BandbBeverages.itemJuiceLemon, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailMorningGloryFizz));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageBrownRum, BandbBeverages.itemBeverageCuracaoTripleSec, BandbBeverages.itemJuiceLime, BandbBeverages.itemBeverageLimonade, BandbBeverages.itemJuiceOrange, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailCitrusCooler));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageWhiteRum, BandbItems.itemMint, Items.sugar, BandbBeverages.itemJuiceLime, BandbBeverages.itemBeveragePerrier, BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailMojito));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageCalvados, BandbBeverages.itemJuiceLemon, BandbBeverages.itemSyrupPureCaneSugar, BandbBeverages.itemBeveragePerrier,BandbItems.itemLemon ,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailHavvardCooler));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemLiqueurRaspberry, BandbBeverages.itemJuiceGrapefruit, BandbBeverages.itemJuiceLemon, BandbBeverages.itemSyrupAlmond,BandbBeverages.itemBeverageSchweppesTonic ,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailBasic));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemLiqueurCherry, BandbBeverages.itemJuiceLemon, BandbBeverages.itemBeveragePerrier, BandbItems.itemMorelloCherry,BandbItems.itemLemon ,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailCherryCooler));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageCampari, BandbBeverages.itemBeverageCuracaoTripleSec, BandbBeverages.itemJuiceLemon, BandbBeverages.itemBeverageSchweppesTonic,BandbItems.itemOrange ,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailTampico));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemJuiceOrange, BandbBeverages.itemJuiceGrapefruit, BandbBeverages.itemBeveragePerrier, BandbBeverages.itemSyrupPureCaneSugar,BandbItems.itemLemon ,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailFlorida));
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemJuiceLime, BandbItems.itemMint, BandbBeverages.itemBeveragePerrier, BandbBeverages.itemSyrupPureCaneSugar,BandbItems.itemLime ,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailSouthsideCooler));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemJuiceTomato, BandbItems.itemCucumber, BandbBeverages.itemJuiceLemon, BandbBeverages.itemSyrupPureCaneSugar,BandbBeverages.itemBeveragePerrier ,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailTomatoCucumberSparkle));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, BandbBeverages.itemBeverageWhiteRum, BandbBeverages.itemJuiceLime, BandbBeverages.itemSyrupGrenadine, BandbBeverages.itemBeveragePontarlier,BandbBeverages.itemBeveragePerrier, BandbItems.itemLime ,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailDoctorFunk));
		...
		RecipeCocktailBar.addRecipe(BandbItems.itemGlassCup, BandbBeverages.itemBeverageEnate, BandbBeverages.itemBeverageCognac, BandbBeverages.itemBeverageCuracaoTripleSec, BandbBeverages.itemJuiceOrange, Items.sugar, BandbItems.itemCinnamon, BandbBeverages.itemBeveragePerrier ,BandbItems.itemLime,BandbItems.itemOrange, new ItemStack(BandbCocktails.itemCocktailSangria));
		...
		for(int i=0; i < ListPineapple.getListSize() ; i++ ){
			...
			RecipeCocktailBar.addRecipe(BandbItems.itemTumbler, ListPineapplejuice.getItem(j), ListPineapple.getItem(i), BandbBeverages.itemSyrupGrenadine,BandbBeverages.itemBeverageSchweppesGingerAle,BandbItems.itemIceCube, new ItemStack(BandbCocktails.itemCocktailBoraBoraBrew));
